...
{
    /// <summary>
    /// Clasa care se ocupa de intrebarile de istorie. Implementeaza interfata Intrebare
    /// </summary>
    public class IntrebareIstorie:Intrebare
    {
        string enunt;
        ...
        public IntrebareIstorie(string enuntul, List<string> variantele, int corecta)
        {
            this.enunt=enuntul;
